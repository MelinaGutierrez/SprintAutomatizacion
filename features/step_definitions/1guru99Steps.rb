...
Given(/^I am on the table page$/) do
  visit 'https://demo.guru99.com/test/table.html'
end
...
Given(/^I am on the Facebook login page$/) do
  visit 'https://demo.guru99.com/test/facebook.html'
end
...
When(/^I press the "([^"]*)" button$/) do |button_text|
  click_button(button_text) || click_link(button_text) || find("label", text: button_text).click
end
